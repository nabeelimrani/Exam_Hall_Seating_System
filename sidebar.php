 ...
 ?>
        ...
        <div class="left-sidebar " style="background-color:#122752">
            
            <div class="scroll-sidebar text-center " style="background-color:#122752; margin-top: 30px;">
                
                <nav class="sidebar-nav  " style="background-color:#122752">
                    <ul id="sidebarnav">
                        <li class="nav-devider"></li>
                        <!-- <li class="nav-label">Home</li> -->
                        <li style="background-color:Bule"> <a href="index.php" aria-expanded="false"><i class="fa fa-window-maximize"></i>Dashboard</a>
                        </li>
                    ...
                    <?php } } ?>
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-clipboard" ></i><span class="hide-menu">Subject Management</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <?php if(isset($useroles)){  if(in_array("manage_exam",$useroles)){ ?> 
                         <!-- <li class="nav-label">Class</li> -->
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-id-card" ></i><span class="hide-menu">Exam Management</span></a>
                            <ul aria-expanded="false" class="collapse"> 
               ...
               <?php if(isset($useroles)){  if(in_array("manage_user",$useroles)){ ?> 
                    ...
                    <li><a href="logout.php" class="btn " style="background: #fd7e01;
    border-radius: 50px;
    margin-right: 45px;
    margin-left: 45px;
    padding: 15px 10px;
    margin-top: 50px;"><i class="fa fa-power-off"></i> Logout</a></li>
