...
?>
 ...
 background-image: url('uploadImage/exam.png "> -->
              <div class="container-fluid" style="background-color :#122752 " >
                <div class="row justify-content-center" >
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                <center>
                                  <img src="uploadImage/Logo/l2.png" style="width:100%;">
                                  <!-- <h1 style="width:50%;">Exam Seating System</h1> -->
                                </center><br>
                                <form method="POST">
                                    ...
                                    <button type="submit" name="btn_login" class="btn btn-primary btn-flat m-b-30 m-t-30" style="background-color:#fd7e01">Sign in</button>
